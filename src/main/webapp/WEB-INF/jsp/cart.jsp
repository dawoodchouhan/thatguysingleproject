		...
		<div class="col-xs-8">
			<div class="panel panel-default">
				...
				<div class="row">
						...
						<div class="col-xs-4">
						<div class="col-xs-5"><label class="form-control input-sm">Quantity</label></div>
						<div class="col-xs-5"> <label class="form-control input-sm">Update</label></div>
						</div>
						<div class="col-xs-2">
				...
				<div class="panel-footer">
					<div class="row text-center">
						<div class="col-xs-3">
							<a href="Welcomepage" class="btn btn-danger btn-sm btn-block">Continue Shopping</a></div>
						<div class="col-xs-6">
